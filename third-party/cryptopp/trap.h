...
//!   is enabled by <tt>CRYPTOPP_DEBUG</tt>, <tt>LLVM_DEBUG</tt> or <tt>_DEBUG</tt>.
...
//! \details <tt>CRYPTOPP_ASSERT</tt> is the library's debugging and diagnostic assertion. <tt>CRYPTOPP_ASSERT</tt>
//!   is enabled by the preprocessor macros <tt>CRYPTOPP_DEBUG</tt>, <tt>LLVM_DEBUG</tt> or <tt>_DEBUG</tt>.
...
//!   <tt>CRYPTOPP_DEBUG</tt>, <tt>LLVM_DEBUG</tt> or <tt>_DEBUG</tt>. Avoiding the defines means <tt>CRYPTOPP_ASSERT</tt>
...
#endif // LLVM_DEBUG and Unix or Windows
