...
public:
    ...
    // pinpoint {
    void visit_bv(ast * n, std::vector<double>& tmp);
    void visit_bv(unsigned n, expr* const* es, std::vector<double>& tmp);
    void visit_bv(expr_ref_vector const& es, std::vector<double>& tmp);
    // }
