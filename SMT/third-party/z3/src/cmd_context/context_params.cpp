...
void context_params::set(char const * param, char const * value) {
    ...
    // Pinpoint {
        ...
        set_uint(m_inc_qfbv, param, value);
    }
    // }
    else if (p == "rlimit") {
...
void context_params::updt_params(params_ref const & p) {
    ...
    // Pinpoint {
    m_inc_qfbv          = p.get_uint("inc_qfbv", m_inc_qfbv);
    // }
...
void context_params::collect_param_descrs(param_descrs & d) {
    ...
    // Pinpoint {
    d.insert("inc_qfbv", CPK_UINT, "Set the tactic for creating the incremental solver,", "0");
    // }
